...
namespace RaoVatWeb.Migrations
{
    ...
    [Migration("20260720152133_RestoreReviews")]
    partial class RestoreReviews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RaoVatWeb.Models.Review", b =>
                {
            ...
            modelBuilder.Entity("RaoVatWeb.Models.ReviewReport", b =>
                {
                    b.Property<int>("ReviewReportId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("ReviewReportId"));
            ...
            modelBuilder.Entity("RaoVatWeb.Models.ReviewReport", b =>
                {
                    b.HasOne("RaoVatWeb.Models.ApplicationUser", "Reporter")
                        .WithMany()
                        .HasForeignKey("ReporterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RaoVatWeb.Models.Review", "Review")
                        .WithMany()
